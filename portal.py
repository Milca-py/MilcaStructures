...
# model.add_member(7, 1, 6, "vigas", BeamTheoriesType.EULER_BERNOULLI)
# model.add_member(8, 6, 5, "vigas", BeamTheoriesType.EULER_BERNOULLI)
...
# model.add_end_length_offset(5, la=lengthOffset)
# model.add_end_length_offset(6, lb=lengthOffset)

model.add_releases(5, mi=True)
model.add_releases(6, mj=True)
# model.add_releases(7, mi=True, mj=True)
# model.add_releases(8, mi=True, mj=True)
