...
class Plotter:
    def __init__(
        ...
        self.axes: Axes = None
        self.model.current_load_pattern = list(self.model.results.keys())[0] if load_pattern is None else load_pattern
        self.current_values: 'PlotterValues' = PlotterValues(self.model, self.model.current_load_pattern)
        ...
        self.model.current_load_pattern = load_pattern
    ...
    def initialize_plot(self):
        ...
        if self.plotter_options.optCargaOP == "max":
            self.plotter_options.load_max(self.model.current_load_pattern)
        elif self.plotter_options.optCargaOP == "mean":
            self.plotter_options.load_mean(self.model.current_load_pattern)
        elif self.plotter_options.optCargaOP == "prom":
            self.plotter_options.load_max(self.model.current_load_pattern, prom=True)
        self.plot_nodes()
        self.plot_members()
        self.plot_cst()
