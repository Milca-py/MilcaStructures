...
def integration_coefficients(element: "Member") -> np.ndarray:
    """
...
def axial_force(element: "Member", factor: float, n: int) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def shear_force(element: "Member", factor: float, n: int) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def bending_moment(element: "Member", factor: float, n: int) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def slope(element: "Member", factor: float, n: int) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def deflection(element: "Member", factor: float, n: int) -> Tuple[np.ndarray, np.ndarray]:
    """
