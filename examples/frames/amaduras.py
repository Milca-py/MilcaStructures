...
cercha.plotter_options.mod_scale_internal_forces = 1.5
cercha.plotter_options.truss_color = "blue"
cercha.plotter_options.truss_deformed_color = "blue"
cercha.plotter_options.mod_rotation_angle_conventional_supports = {1: 270, nt+1: 270, nt: 90, nt+nt: 90}
