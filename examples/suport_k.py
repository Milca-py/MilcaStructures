...
model.add_shell_section("muro", "concreto", 0.25)
...
model.add_cst(4, 1, 3, 2, "muro")
model.add_cst(5, 1, 4, 3, "muro")
model.add_restraint(1, *(True, True, True))
model.add_restraint(4, *(True, False, False))
model.add_elastic_support(4, ky=200, krz=200)
model.add_elastic_support(3, krz=100)
model.add_elastic_support(2, kx=-100)
