...
portico.add_restraint(6, (True, True, True))

portico.add_load_pattern("CARGA1")
portico.add_point_load(3, "CARGA1", 10)
portico.add_distributed_load(2, "CARGA1", -5, -5)
portico.add_distributed_load(3, "CARGA1", -5, -5)
portico.add_distributed_load(4, "CARGA1", -5, -5)
